...
- **言語**: Java 21 (開発・ビルド環境)
  ...
  - **1.8.x 対応**: Java 7 または 8 で動作させる必要があるため、コアロジックは低バージョン互換の文法（Java 7/8）で記述するか、ターゲットバージョンごとにバイナリを分ける構成を検討してください。
  - **1.17.x 〜 1.20.x 対応**: Java 16 / 17 以降が必要。
  - **1.21.x 対応**: Java 21 が必須。
